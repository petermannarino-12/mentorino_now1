  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-6 animate-in fade-in duration-700">
      <SEO 
        ...
        description="Read the Mentorino Terms of Service to understand your rights and responsibilities when using our platform."
      />
      <button 
        onClick={() => navigate(-1)}
      ...
      <div className="space-y-12 text-slate-600 font-medium leading-relaxed">
        <section className="space-y-4">
          ...
          <p>By accessing and using Mentorino, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.</p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p>All content provided, including but not limited to strategy frameworks, worksheets, and recordings, remains the intellectual property of Mentorino.</p>
        </section>
      </div>
